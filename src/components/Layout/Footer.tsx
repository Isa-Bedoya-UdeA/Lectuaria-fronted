        ...
        <footer>
            <section className="footer__columns">
                ...
                <article className="footer__legal">
                    <h3>Legal</h3>
                    <Link to={PATHS.TERMS}>Términos de Uso</Link>
                    <Link to={PATHS.PRIVACY}>Privacidad</Link>
                    <Link to={PATHS.COOKIES}>Cookies</Link>
                </article>
                <article className="footer__libraries">
                    <h3>Bibliotecas</h3>
                    <a href="https://bibliotecasmedellin.gov.co/nuestras-bibliotecas/" target="_blank" rel="noopener noreferrer">
                        Sistema de Bibliotecas de Medellín <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" aria-hidden="true"><path fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M21 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h6m10 0l-9 9m3-9h6v6" /></svg>
                    </a>
                </article>
            </section>
